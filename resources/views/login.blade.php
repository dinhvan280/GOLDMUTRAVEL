...
<head>
    ...
    <!--Bootstrap CSS-->
    <link href="{{asset('assets/css/opensans.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{asset('assets/css/font-awesome.min.css')}}" rel="stylesheet" type="text/css"/>

    <link rel="stylesheet" href="{{asset('assets/css/login/login.css')}}">
    <link rel="stylesheet" href="{{asset('assets/css/bootstrap.css')}}">
    <link rel="stylesheet" href="{{asset('assets/css/login/components.min.css')}}">

    <script type="text/javascript" src="{{asset('assets/js/libs/jquery-2.2.3.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/js/libs/bootstrap.js')}}"></script>
    ...
    <div class="content">
        ...
        <form class="login-form" method="POST" action="{{ route('login') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="Tên tài khoản" name="name" />
                @error('name')
            ...
            <div class="form-actions">
                ...
                <a href="javascript:void(0)" id="forget-password" onclick="actionForm('forget_password')"
                   class="forget-password">Quên mật khẩu?</a>
            </div>
        ...
        <form class="forget-form" action="{{ route('password.email') }}" method="post">
            ...
            <div class="form-group">
                <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Email"
                       name="email"/></div>
            <div class="form-actions">
                <button type="button" id="back-btn" onclick="actionForm('back_btn')" class="btn green btn-outline">
                    Back
                </button>
