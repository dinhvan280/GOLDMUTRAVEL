                        ...
                        <ul id="accordion" class="accordion">
                            ...
                            <li>
                                ...
                                <div class="submenu wysiwyg">
                                    ...
                                    <p style="text-align: justify;">Đa số các nhà xe đều chấp nhận khi bạn có thể xuất
                                        ...
                                        trong phần đặt vé của GOLDMUTRAVEL), bạn vui lòng đổi vé của các hãng xe này để lên
                                        xe.</p>
                            ...
                            <li>
                                ...
                                <div class="submenu wysiwyg">
                                    ...
                                    <p style="text-align: justify;">Mỗi nhà xe có chính sách khác nhau, nhưng thông
                                        ...
                                        thì GOLDMUTRAVEL không phải chịu trách nhiệm liên đới." Tuy nhiên, GOLDMUTRAVEL sẽ phối hợp với
                                        nhà xe để giải quyết cho khách ổn thỏa nhất có thể. Quý khách vui lòng liên hệ
                                        Tổng đài GOLDMUTRAVEL 1900636750 để được hỗ trợ.&nbsp;</p>
                            ...
                            <li>
                                ...
                                <div class="submenu wysiwyg">
                                    ...
                                    <p style="text-align: justify;">GOLDMUTRAVEL cam kết hoàn tiền cho quý khách nếu có lỗi xảy
                                        ra từ phía nhà xe cung cấp dịch vụ hoặc do sai sót từ phía GOLDMUTRAVEL. Trong trường
                                        hợp nếu quý khách lỡ chuyến xe vì bất cứ lý do nào khác, GOLDMUTRAVEL sẽ không cam kết
                                        hoàn tiền cho quý khách.</p>

                                </div>
                            </li>
                            <li>
                                <div class="link">GOLDMUTRAVEL hoàn tiền trong bao lâu sau khi tôi đã huỷ vé?<i
                                        class="fa fa-angle-down"></i></div>
                                <div class="submenu wysiwyg">


                                    <p style="text-align: justify;">Trong hầu hết trường hợp (trừ các trường hợp chẳng
                                        hạn như tiền hoàn vé được sử dụng để mua vé khác tại GOLDMUTRAVEL.vn), GOLDMUTRAVEL sẽ tiến hành
                            ...
                            <li>
                                ...
                                <div class="submenu wysiwyg">
                                    ...
                                    <p style="text-align: justify;">Sau khi khách hàng thanh toán thành công, GOLDMUTRAVEL sẽ
                                        ...
                                        lúc lên xe, Quý khách vui lòng liên hệ đến GOLDMUTRAVEL qua số Tổng Đài: 1900 636 750 để
                            ...
                            <li>
                                <div class="link">Làm thế nào để tôi xuất hoá đơn tại GOLDMUTRAVEL?<i
                                        class="fa fa-angle-down"></i></div>
                                <div class="submenu wysiwyg">
                                    ...
                                    <p style="text-align: justify;">Trong ngành xe khách vé giấy được xem tương đương
                                        ...
                                        khi đặt vé thành công, Quý khách gọi đến Tổng đài của GOLDMUTRAVEL để báo trước việc
                                        ...
                                        giấy, quý khách cũng vui lòng liên hệ đến Tổng đài của GOLDMUTRAVEL để được hỗ trợ.
                                        Hotline tổng đài GOLDMUTRAVEL là 1900 636 750.&nbsp;</p>
                            ...
                            <li>
                                ...
                                <div class="submenu wysiwyg">
                                    ...
                                    <p style="text-align: justify;">Hiện tại GOLDMUTRAVEL chưa hỗ trợ khách hàng việc thanh toán
                            ...
                            <li>
                                ...
                                <div class="submenu wysiwyg">
                                    ...
                                    <p style="text-align: justify;">Sau khi nhấn nút “Thanh toán” trên màn hình thanh
                                        toán, GOLDMUTRAVEL sẽ gửi đến hộp thư mà Quý khách đã đăng ký lúc đặt vé một email chứa
                            ...
                            <li>
                                <div class="link">Cách thanh toán vé trên GOLDMUTRAVEL?<i class="fa fa-angle-down"></i></div>
                                <div class="submenu wysiwyg">


                                    <p style="text-align: justify;">Hiện tại GOLDMUTRAVEL cho phép khách hàng thanh toán trực
                            ...
                            <li>
                                ...
                                <div class="submenu wysiwyg">
                                    ...
                                    <p style="text-align: justify;">Trong trường hợp không nhận được email xác nhận đặt
                                        vé thành công từ GOLDMUTRAVEL, quý khách vui lòng gọi đến tổng đài 1900636750 để kiểm
                            ...
                            <li>
                                ...
                                <div class="submenu wysiwyg">
                                    ...
                                    <p style="text-align: justify;">Một số chuyến chưa hỗ trợ chọn vị trí ghế ngồi trên
                                        xe. Trong trường hợp này, GOLDMUTRAVEL sẽ hỗ trợ khách hàng thông báo số lượng vé với
                            ...
                            <li>
                                <div class="link">Làm cách nào để tôi đăng ký tài khoản trên website GOLDMUTRAVEL?<i
                                        class="fa fa-angle-down"></i></div>
                                <div class="submenu wysiwyg">


                                    <p style="text-align: justify;">Khách hàng có thể dễ dàng đăng ký tài khoản trên
                                        website GOLDMUTRAVEL thông qua 3 bước như sau:&nbsp;</p>
                                    ...
                                    <p style="text-align: justify;"><strong>Bước 3:</strong> Điền thông tin cần thiết
                                        vào form đăng ký để tạo tài khoản trên hệ thống của GOLDMUTRAVEL</p>
                            ...
                            <li>
                                <div class="link">GOLDMUTRAVEL có xác nhận đơn hàng với tôi không?<i
                                        class="fa fa-angle-down"></i></div>
                                <div class="submenu wysiwyg">


                                    <p style="text-align: justify;">Sau khi thanh toán, GOLDMUTRAVEL sẽ cung cấp email xác nhận
                                    ...
                                    <p style="text-align: justify;">Nếu nhà xe không chấp nhận email xác nhận thanh toán
                                        ...
                                        hệ đến GOLDMUTRAVEL qua số Tổng Đài: 1900 636 750 để được hỗ trợ kịp thời. Nhà xe sẽ
