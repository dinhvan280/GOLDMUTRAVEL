                            ...
                            <div class="col-12 col-lg-8 mt-4">
                                    ...
                                    <div class="col-12 col-lg-6 search-form-item"><label>Nơi đi</label>
                                        <div class="search-drop">
                                            ...
                                            <input type="text" id="pickupPoint" value="" autocomplete="off"
                                                   ...
                                                   placeholder="Chọn nơi đi" name="departure">
                                    ...
                                    <div class="col-12 col-lg-6 search-form-item"><label>Nơi đến</label>
                                        <div class="search-drop">
                                            ...
                                            <input type="text" id="dropOffPoint" autocomplete="off"
                                                   ...
                                                   placeholder="Chọn nơi đến" name="destination">
                                ...
                                <div class="mb-3 mb-lg-0 mt-4 row">
                                    ...
                                    <div class="col-12 col-lg-6 search-form-item">
                                        ...
                                        <button type="button" id="btn-search" class="btn-search btn-ani2">Tìm kiếm
                                        </button>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <div class="content-info-content">
                                                        <div class="content-info-line">
                                                            <div class="item"><p>Nơi đi</p>
                                                                <p id="start_point"
                                                                   class="start_point_{{$items}}">{{$item->diem_dau}}</p>
                                                            </div>
                                                            <div class="item"><p>Thời gian đi</p>
                                                                <p id="time_start"
                                                                   class="time_start_{{$items}}">{{date('G:i', strtotime($item->gio))}}</p>
                                                            </div>
                                                            <div class="item"><p>Nơi đến</p>
                                                                <p id="end_point"
                                                                   class="end_point_{{$items}}">{{$item->diem_cuoi}}</p>
                                                            </div>
                                                            <div class="item"><p>Thời gian đến</p>
                                                                <p id="time_end"
                                                                   class="time_end_{{$items}}">{{ \Carbon\Carbon::parse($item->gio)->addHours(2)->addMinutes(50)->format('G:i') }}</p>
                                                            </div>
                                                        </div>
