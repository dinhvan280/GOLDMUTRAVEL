                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-2" style="padding: 0px;">
                            <a href="{{route('types.create')}}" class="btn btn-success form-control btnAddNew">
                                <i class="fa fa-plus"></i> Thêm loại xe mới
                            </a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="x_content">
                            <table id="datatable-buttons"
                                ...
                                <tr>
                                    ...
                                    <th class="text-center" style="width:15%">Tên loại xe</th>
                                    <th class="text-center" style="width:15%">Số ghế</th>
                                    <th class="text-center" style="width:10%">Giá vé</th>
                                    <th class="text-center" style="width:10%">Hành động</th>
                                </tr>
                                </thead>

                                <tbody>
                                @foreach ($listLoai as $id => $value)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{route('types.edit', $value->id)}}" style="min-width:100px;"
