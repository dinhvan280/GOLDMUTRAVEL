            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form class="form-horizontal form-label-left" action="{{route('trips.update', $chuyen->id)}}"
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="ten_chuyen" value="{{$chuyen->ten_chuyen}}" class="form-control col-md-7 col-xs-12"  name="ten_chuyen" type="text">
                                        @if ($errors->has('ten_chuyen'))
                                            <div id="formMessage" class="alert alert-danger">
                                                <strong>{{ $errors->first('ten_chuyen') }}</strong>
                                            </div>
                                        @endif
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-12">
                                        <select name="ten_tuyen" id="" class="form-control" value="{{$tuyen->ten_tuyen}}">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-12">
                                        <input type="time" id="timetrips" name="gio" value="{{$chuyen->gio}}">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="thu_tu" value="{{$chuyen->thu_tu}}" class="form-control col-md-7 col-xs-12"  name="thu_tu" type="text">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="chieu" value="{{$chuyen->chieu}}" class="form-control col-md-7 col-xs-12"  name="chieu" type="text">
                                            @if ($errors->has('chieu'))
                                                <div id="formMessage" class="alert alert-danger">
