                    ...
                    <div class="col-md-12">
                        <div class="col-md-2" style="padding: 0px;">
                            <a href="{{route('trips.create')}}" class="btn btn-success form-control btnAddNew">
                                <i class="fa fa-plus"></i> Thêm chuyến mới
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="tab-content">
                            @foreach($listTuyen as $i => $road)
                                <div id="{{$road->id}}" class="tab-pane fade {{$i== 0 ?"in active" : "" }}">
                                    <div class="x_content">
...
{{--    <script src="{{asset('build/js/custom.js')}}"></script>--}}
    <script type="text/javascript">
        ...
        function ConfirmDelete() {
            var x = confirm("Bạn có thực sự muốn xóa chuyến xe này?");
            if (x)
                return true;
            else
                return false;
