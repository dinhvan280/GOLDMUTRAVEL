            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h3>Cập nhật chuyến ngày</h3>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-2" style="padding: 0px;">
                            <a href="{{route('trips_day.create')}}" class="btn btn-success form-control btnAddNew">
                                <i class="fa fa-plus"></i> Thêm chuyến ngày
                            </a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="x_content">
                            <table id="datatable-buttons"
                                ...
                                <tr>
                                    ...
                                    <th class="text-center" style="width:15%">Tên chuyến</th>
                                    <th class="text-center" style="width:15%">Loại xe</th>
                                    <th class="text-center" style="width:15%">Tên xe</th>
                                    <th class="text-center" style="width:10%">Ngày chạy</th>
                                    <th class="text-center" style="width:10%">Hành động</th>
                                </tr>
                                </thead>

                                <tbody>
                                @foreach ($listChuyenNgay as $key => $value)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{route('trips_day.edit', $value->id)}}" style="min-width:100px;"
                                               class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Cập nhật</a>
                                            <form action="{{route('trips_day.destroy', $value->id)}}" method="post">
...
@push('js')
    ...
    <script type="text/javascript">
        ...
        function ConfirmDelete() {
            var x = confirm("Bạn có thực sự muốn xóa chuyến ngày này?");
            if (x)
                return true;
            else
                return false;
