                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form class="form-horizontal form-label-left"
                                  action="{{route('cars.update', $xe->id)}}" enctype="multipart/form-data"
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="ten_xe" value="{{$xe->ten_xe}}"
                                               class="form-control col-md-7 col-xs-12" name="ten_xe" type="text"
                                               required>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Biển số
                                        <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="bien_so" value="{{$xe->bien_so}}"
                                               class="form-control col-md-7 col-xs-12" name="bien_so" type="text"
                                               required>
...
{{--                                            <img src="{{url('/')}}/{{$xe->anh}}" alt="" id="img_show">--}}
{{--                                            <i class="">+</i>--}}
{{--                                        </div>--}}
...
{{--                                </div>--}}
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="number">Giới thiệu <span
                                                class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea name="gioi_thieu" id="editor1" value="{{$xe->gioi_thieu}}"
                                                  class="form-control editor1" cols="30" rows="5" placeholder="Giới thiệu"
                                                  required>
                                            {!! $xe->gioi_thieu!!}
                                        </textarea>
