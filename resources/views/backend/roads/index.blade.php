                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-2" style="padding: 0px;">
                            <a href="{{route('roads.create')}}" class="btn btn-success form-control btnAddNew">
                                <i class="fa fa-plus"></i> Thêm tuyến
                            </a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="x_content">
                            <table id="datatable-buttons"
                                ...
                                <tr>
                                    ...
                                    <th class="text-center" width="20%">Điểm đầu</th>
                                    <th class="text-center" width="20%">Điểm cuối</th>
                                    <th class="text-center" width="20%">Điểm dừng nghỉ</th>
                                    <th class="text-center" width="15%">Hành động</th>
                                </tr>
                                </thead>
                                <tbody>
                                    @foreach ($listTuyen as $id => $value)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{route('roads.edit', $value->id)}}" style="min-width:100px;"
                                                   class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Cập nhật</a>
                                                <form action="{{route('roads.destroy', $value->id)}}" method="post">
...
//            'order': [[3, 'asc']],
    ...
    function ConfirmDelete() {
        var x = confirm("Bạn có muốn xóa tuyến đường này?");
        if (x)
            return true;
        else
            return false;
