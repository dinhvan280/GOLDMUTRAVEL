                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-2" style="padding: 0px;">
                            <a href="{{route('image.create', ['id' => $xe->id])}}" class="btn btn-success form-control btnAddNew">
                                <i class="fa fa-plus"></i> Thêm hình ảnh xe mới
                            </a>
                        </div>
                    </div>
                </div>
                                ...
                                @foreach ($images as $id => $value)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <img src="{{asset($value->anh)}}" style="width: 120px;" alt="">
                                        </td>
                                        <td class="text-center">
                                            <a href="{{route('images.edit', $value->id)}}" style="min-width:100px;"
                                               class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Cập nhật</a>
                                            <form action="{{route('images.destroy', $value->id)}}" method="post">
